...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
	    ...
	    // Convert PointFeatures from earthquakes to SimplePointMarkers and store in markers list
	    for(PointFeature pf :  earthquakes){
	    	SimplePointMarker marker = new SimplePointMarker(pf.getLocation(),pf.getProperties());
